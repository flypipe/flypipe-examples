...
# MAGIC %sql
# MAGIC select metadata_year, metadata_month, count(1) from nyc_tlc.bronze_yellow_trip group by 1,2;
...
silver_yellow_trip.run(
    spark, 
    inputs={
        download_load_bronze: spark.table("nyc_tlc.bronze_yellow_trip")
    },
    parameters={
...
silver_yellow_trip.run(
    ...
    parameters={
        ...
        silver_yellow_trip: {'year': 2022, 'month': 11, 'write': True}
    }
)
